...
% Set ranges
% Row: case_fatality_y, transmission_coeff, cost_per_clinical_case
% Column: lower value, upper value
test_range = nan(3, 2);
...
% Set ranges
% Row: cost_per_vacc, cost_per_clinical_case, qalyloss_per_clinical_case,
% qalyloss_per_death
...
for i = 1:n_parameter
    ...
    test_sample(:, i) = nan(n_sample, 1);% Use rand function
end
...
ICER_mean = nan;
ICER_left95 = nan;% Use quantile function
ICER_right95 = nan;
