...
total_clinical_case_novac = nan;
total_clinical_case_A = nan;
...
total_death_novac = nan;
total_death_A = nan;
total_death_static = [total_death_novac, total_death_A, total_death_novac - total_death_A];

number_vaccinated_static = nan(1, 3);

vaccine_cost_static = nan(1, 3);

treatment_cost_static = nan(1, 3);

total_cost_static = nan(1, 3);

qaly_loss_clinical_case_static = nan(1, 3);

qaly_loss_death_static = nan(1, 3);

total_qaly_loss_static = nan(1, 3);

incremental_cost_per_case_prevented_static = [0, 0, nan];
incremental_cost_per_death_prevented_static = [0, 0, nan];
incremental_cost_per_qaly_gained_static = [0, 0, nan];
