function estimated_foi = estimate_foi(initial_guess, data, diff_age)
%estimate_foi - estimate the foi values from data initial guess
%
% Syntax: estimated_foi = estimate_foi(initial_guess, data)
%
...
if nargin == 3
    output = seroprev(ages, guessed_foi);
else
    output = seroprev(ages, guessed_foi, diff_age);
end
