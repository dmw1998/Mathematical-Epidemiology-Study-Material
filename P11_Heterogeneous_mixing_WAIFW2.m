...
end_time = 200*365;
% y0 = [S_y, I_y, I_y, N_y-S_y-I_y-I_y, S_m, I_m, I_m, N_m-S_m-I_m-I_m, S_o, I_o, I_o, N_o-S_o-I_o-I_o]
y0 = [5000, 20, 20, N_y-5000-20-20, 3000, 3, 3, N_m-3000-3-3, 2700, 3, 3, N_o-2700-3-3];

vac = @(t) logical(floor(t/(100*365)))*c;

odefunA = @(t,y) [(1-vac(t))*N0*b-(WAIFW_A(1,:)*[y(3);y(7);y(11)]+a_y)*y(1); ...
    WAIFW_A(1,:)*[y(3);y(7);y(11)]*y(1)-(f+a_y)*y(2); ...
    f*y(2)-(r+a_y)*y(3); ...
    vac(t)*b*N0+r*y(3)-a_y*y(4); ...
    a_y*y(1)-(WAIFW_A(2,:)*[y(3);y(7);y(11)]+a_m)*y(5); ...
    WAIFW_A(2,:)*[y(3);y(7);y(11)]*y(5)+a_y*y(2)-(f+a_m)*y(6); ...
    f*y(6)+a_y*y(3)-(r+a_m)*y(7); ...
    r*y(7)+a_y*y(4)-a_m*y(8); ...
    a_m*y(5)-(WAIFW_A(3,:)*[y(3);y(7);y(11)]+d)*y(9); ...
    WAIFW_A(3,:)*[y(3);y(7);y(11)]*y(9)+a_m*y(6)-(f+d)*y(10); ...
    f*y(10)+a_m*y(7)-(r+d)*y(11); ...
...
odefunB = @(t,y) [(1-vac(t))*N0*b-(WAIFW_B(1,:)*[y(3);y(7);y(11)]+a_y)*y(1); ...
    ...
    f*y(2)-(r+a_y)*y(3); ...
    vac(t)*b*N0+r*y(3)-a_y*y(4); ...
    a_y*y(1)-(WAIFW_B(2,:)*[y(3);y(7);y(11)]+a_m)*y(5); ...
    WAIFW_B(2,:)*[y(3);y(7);y(11)]*y(5)+a_y*y(2)-(f+a_m)*y(6); ...
    f*y(6)+a_y*y(3)-(r+a_m)*y(7); ...
    r*y(7)+a_y*y(4)-a_m*y(8); ...
    a_m*y(5)-(WAIFW_B(3,:)*[y(3);y(7);y(11)]+d)*y(9); ...
    WAIFW_B(3,:)*[y(3);y(7);y(11)]*y(9)+a_m*y(6)-(f+d)*y(10); ...
    f*y(10)+a_m*y(7)-(r+d)*y(11); ...
    r*y(11)+a_m*y(8)-d*y(12)];
